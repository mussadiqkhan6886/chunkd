...
export async function generateStaticParams() {
  ...
  const cookies = await CookieSchema.find({category: "bundle"}, { slug: 1 }).lean();
...
export async function generateMetadata(
  ...
  return {
    ...
    keywords: ["drops", "limited drop", "cookie", "limited time", "cookie", "time", "bundle", "best cookies bundle in lahore", "bundles in lahore", "cookies bundle in lahore", "cookies in islamabad"],
    openGraph: {
