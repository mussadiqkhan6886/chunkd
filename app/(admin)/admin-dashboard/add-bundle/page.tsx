...
const AddProduct = () => {
  ...
  return (
    <main className="p-6 flex flex-col items-center lg:px-20 md:px-17 px-5">
      <h1 className="text-2xl font-bold mb-6">Add New Bundle</h1>
      ...
      <form className="grid gap-4 w-full md:w-[50%]" onSubmit={handleSubmit}>
        ...
        {/* Product Name & Slug */}
        <div>
          <label className="block font-semibold mb-1">Bundle Name</label>
          <input
            name="title"
            value={data.title}
            onChange={handleChange}
       ...
       <div>
        ...
        {/* Images */}
        <div>
          <label className="block font-semibold mb-1">Bundle Images</label>
